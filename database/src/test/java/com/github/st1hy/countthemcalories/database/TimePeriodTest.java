...
public class TimePeriodTest {
    ...
    public void testMedian() throws Exception {
        assertThat(TimePeriod.median(arr()), equalTo(0f));
        assertThat(TimePeriod.median(arr(2.552f)), equalTo(2.552f));
        assertThat(TimePeriod.median(arr(3f, 4.f)), equalTo(3.5f));
        assertThat(TimePeriod.median(arr(-2f, 1f, 2312313f)), equalTo(1f));
    }
    ...
    public void testMedian2() throws Exception {
        ...
        assertThat(TimePeriod.median(arr(-2f, 1f, 2312313f), 0, 3), equalTo(1f));
        assertThat(TimePeriod.median(arr(-2f, 1f, 2312313f), 1, 3), equalTo(1156157f));
        assertThat(TimePeriod.median(arr(-2f, 1f, 2312313f), 1, 2), equalTo(1f));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testMedian3() throws Exception {
        TimePeriod.median(arr(), -1, 0);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testMedian4() throws Exception {
        TimePeriod.median(arr(), 2, 1);
    }

    @Test(expected = ArrayIndexOutOfBoundsException.class)
    public void testMedian5() throws Exception {
        TimePeriod.median(arr(), 5, 7);
    }

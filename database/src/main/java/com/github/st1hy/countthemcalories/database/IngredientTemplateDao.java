...
import com.github.st1hy.countthemcalories.database.property.EnergyDensityPropertyConverter;
...
public class IngredientTemplateDao extends AbstractDao<IngredientTemplate, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property EnergyDensity = new Property(4, String.class, "energyDensity", false, "ENERGY_DENSITY");
    };
    ...
    private final EnergyDensityPropertyConverter energyDensityConverter = new EnergyDensityPropertyConverter();
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"INGREDIENTS_TEMPLATE\" (" + //
                ...
                "\"ENERGY_DENSITY\" TEXT NOT NULL );"); // 4: energyDensity
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, IngredientTemplate entity) {
        ...
        stmt.bindString(5, energyDensityConverter.convertToDatabaseValue(entity.getEnergyDensity()));
    }
    ...
    public IngredientTemplate readEntity(Cursor cursor, int offset) {
        IngredientTemplate entity = new IngredientTemplate( //
            ...
            energyDensityConverter.convertToEntityProperty(cursor.getString(offset + 4)) // energyDensity
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, IngredientTemplate entity, int offset) {
        ...
        entity.setEnergyDensity(energyDensityConverter.convertToEntityProperty(cursor.getString(offset + 4)));
     }

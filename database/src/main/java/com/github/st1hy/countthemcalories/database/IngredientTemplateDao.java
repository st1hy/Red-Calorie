...
public class IngredientTemplateDao extends AbstractDao<IngredientTemplate, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, IngredientTemplate entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, IngredientTemplate entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(IngredientTemplate entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(IngredientTemplate entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(IngredientTemplate entity) {

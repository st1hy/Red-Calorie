...
import static com.github.st1hy.countthemcalories.ui.core.drawer.DrawerMenuItem.OVERVIEW;
import static com.github.st1hy.countthemcalories.ui.core.drawer.DrawerMenuItem.SETTINGS;
...
public final class DrawerPresenter implements BasicLifecycle, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onStart() {
        ...
        view.setMenuItemSelection(currentItem().getMenuItemId(), Selection.SELECTED);

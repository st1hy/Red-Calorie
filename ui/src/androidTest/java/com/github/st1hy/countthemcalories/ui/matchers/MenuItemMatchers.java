package com.github.st1hy.countthemcalories.ui.matchers;
...
import static com.github.st1hy.countthemcalories.ui.matchers.IterableMatchers.atLeastOne;
...
public class MenuItemMatchers {
    ...
    public static Matcher<MenuItem> withMenuId(final int menuItemId) {
        return new BoundedMatcher<MenuItem, MenuItem>(MenuItem.class) {
            ...
            @Override
            public void describeTo(Description description) {
                description.appendText(String.format("have menu id: %s", Matchers.resIdToString(viewResources, menuItemId)));
            }
        };
    }

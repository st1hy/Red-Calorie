...
public class IngredientsAdapterTest {
    ...
    public void setUp() throws Exception {
        ...
        when(model.removeExtraIngredientType()).thenReturn(Optional.<IngredientTypeParcel>absent());
    ...
    private void testVerifyStart() {
        ...
        verify(model).removeExtraIngredientType();
    ...
    public void testAddExtraIngredient() throws Exception {
        ...
        when(model.removeExtraIngredientType()).thenReturn(Optional.of(parcel));
